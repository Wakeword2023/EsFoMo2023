...
Adapted for quantization using https://github.com/Forggtensky/Quantize_Pytorch_Vgg16AndMobileNet/blob/main/vgg16-static_quantize.py
"""
...
class VGG(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(0, len(self.features)):
            self.names.append(str(self.features[i]))
